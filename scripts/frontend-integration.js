 ...
 * This file demonstrates how to integrate Bridgeorbit with a web frontend
 */

// For React/Vue/Angular applications
export class BridgeorbitClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new BridgeorbitClient(provider, contractAddress);

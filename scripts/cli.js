...
const contractABI = require("../artifacts/contracts/Bridgeorbit.sol/Bridgeorbit.json").abi;

program
    .name("bridgeorbit-cli")
    .description("CLI tool for Bridgeorbit smart contract")
    .version("1.0.0");
